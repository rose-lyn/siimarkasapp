<nav class="sidebar sidebar-offcanvas" id="sidebar">
    <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
        <a class="sidebar-brand brand-logo" href="<?= base_url('index.') ?>"><img src="<?= base_url('assets/images/logo.svg') ?>" alt="logo" /></a>
        <a class="sidebar-brand brand-logo-mini" href="<?= base_url('index.') ?>"><img src="<?= base_url('assets/images/logo-mini.svg') ?>" alt="logo" /></a>
    </div>
    <ul class="nav">
        ...
        <div class="profile-desc">
            ...
            <div class="profile-name">
                <h5 class="mb-0 font-weight-normal"><?= substr(session()->get('nama'),0,12) ?></h5>
                <span><?= session()->get('nia') ?></span>
            </div>
            </div>
        ...
        <div class="collapse" id="ui-basic">
            ...
            <li class="nav-item"> <a class="nav-link" href="<?= base_url('pages/ui-features/buttons.html') ?>">Buttons</a></li>
